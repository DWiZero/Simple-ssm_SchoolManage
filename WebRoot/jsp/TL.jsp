...
<body>
    ...
    <ul class="nav sidebar-nav">
          ...
          <li>
              <a href="${pageContext.request.contextPath}/tm/ti.action" target="main"><i class="fa fa-fw fa-home"></i> 基本信息</a>
          </li>
          ...
          <li>
              <a href="${pageContext.request.contextPath}/tm/tc.action" target="main"><i class="fa fa-fw fa-cog"></i> 所有课程</a>
          </li>
          <li class="dropdown" id="mean">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li class="dropdown-header">Dropdown heading</li>
              <li><a href="${pageContext.request.contextPath}/tm/ti.action?method=updata" target="main">修改信息</a></li> 
				<li><a href="${pageContext.request.contextPath}/tm/tutp.action?method=find" target="main">修改密码</a></li>              
            </ul>
          </li>         
      </ul>
